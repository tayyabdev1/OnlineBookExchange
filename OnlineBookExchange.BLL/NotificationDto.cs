...
namespace OnlineBookExchange.BLL
{
    public class NotificationDto
    {
        ...
        public bool DeclineRequest(NotificationDto notificationDto)
        {
            var newNotification = new Notifications
            {
                UserID = notificationDto.UserID, // Sender ID
                Message = notificationDto.Message, // Example: "Your exchange request has been declined."
                ReadStatus = notificationDto.ReadStatus,
                CreatedAt = DateTime.Now,
                ReceiverId = notificationDto.ReceiverId, // The user who receives the decline notification
                Status = "Declined",
                BookID = notificationDto.BookID,
                IsHandled=notificationDto.IsHandled,
            };
